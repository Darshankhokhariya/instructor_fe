...
import { FaClipboardList, FaPhoneAlt, FaVideo, FaCheckCircle, FaUserCheck } from "react-icons/fa";

// Sample data for applications
const sampleApplications = [
    { id: 1, name: "Ramesh Patel", status: "Pending", managerApproval: false, adminApproval: false },
    { id: 2, name: "Sita Sharma", status: "Approved", managerApproval: true, adminApproval: false },
    { id: 3, name: "Rahul Mehta", status: "Pending", managerApproval: true, adminApproval: true },
];
        ...
        <Layout>
            <div className="p-6 bg-gray-50">
                ...
                <div className="w-[70%] mt-6">
                    <RecentApplications data={data} updateField={updateField} />
                </div>
            </div>
        </Layout>
    );
