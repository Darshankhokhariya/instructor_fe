...
import { InstructorSignup, setOtpEmail, userSignup } from "@/redux/slices/userSlice";
      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid grid-cols-1 md:grid-cols-2 overflow-hidden">
        ...
        <div className="px-8 py-6 md:px-16 lg:px-20 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-[#0f766e] hover:bg-[#115e59] text-white py-3.5 rounded-xl font-semibold text-lg transition-all shadow-lg hover:shadow-xl"
            >
              Create Account
            </button>
          </form>
